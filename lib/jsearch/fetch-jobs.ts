...
const LAYER_1_QUERIES = [
  "site:linkedin.com/jobs finance jobs in Saudi Arabia",
  "site:linkedin.com/jobs accountant jobs in Riyadh",
  "site:linkedin.com/jobs financial analyst jobs in Saudi Arabia",
  "site:linkedin.com/jobs finance manager jobs in Saudi Arabia",
  "site:linkedin.com/jobs financial controller jobs in Saudi Arabia",
  "site:linkedin.com/jobs FP&A jobs in Saudi Arabia",
  "site:linkedin.com/jobs finance jobs in Dubai",
  "site:linkedin.com/jobs accountant jobs in Dubai",
  "site:linkedin.com/jobs financial analyst jobs in Dubai",
  "site:linkedin.com/jobs finance manager jobs in Dubai",
  "site:linkedin.com/jobs financial controller jobs in Dubai",
  "site:linkedin.com/jobs FP&A jobs in Dubai",
  "Naukri Gulf finance jobs in Saudi Arabia",
  "Naukri Gulf accountant jobs in Saudi Arabia",
  "Naukri Gulf finance manager jobs in Saudi Arabia",
  "Naukri Gulf finance jobs in Dubai",
  "Naukri Gulf accountant jobs in Dubai",
  "Naukri Gulf financial analyst jobs in Dubai",
  "Indeed finance jobs in Saudi Arabia",
  "Indeed accountant jobs in Riyadh",
  "Indeed finance manager jobs in Saudi Arabia",
  "Indeed finance jobs in Dubai",
  "Indeed accountant jobs in Dubai",
  "Indeed financial analyst jobs in Dubai",
];

const LAYER_2_QUERIES = [
  "LinkedIn treasury jobs in Saudi Arabia",
  "LinkedIn tax jobs in Saudi Arabia",
  "LinkedIn audit jobs in Saudi Arabia",
  "LinkedIn finance director jobs in Saudi Arabia",
  "LinkedIn head of finance jobs in Saudi Arabia",
  "LinkedIn treasury jobs in Dubai",
  "LinkedIn tax jobs in Dubai",
  "LinkedIn audit jobs in Dubai",
  "LinkedIn finance director jobs in Dubai",
  "LinkedIn head of finance jobs in Dubai",
  "Naukri Gulf treasury jobs in Saudi Arabia",
  "Naukri Gulf audit jobs in Dubai",
  "Bayt finance jobs in Saudi Arabia",
  "Bayt accountant jobs in Saudi Arabia",
  "Bayt finance jobs in Dubai",
  "Bayt accountant jobs in Dubai",
  "GulfTalent finance jobs in Saudi Arabia",
  "GulfTalent accountant jobs in Saudi Arabia",
  "GulfTalent finance jobs in Dubai",
  "GulfTalent accountant jobs in Dubai",
...
const LAYER_3_QUERIES = [
  ...
  "Jobleads finance jobs in Saudi Arabia",
  "Jobleads finance jobs in Dubai",
  "Jooble finance jobs in Saudi Arabia",
  "Jooble finance jobs in Dubai",
  "Trabajo finance jobs in Saudi Arabia",
  "Trabajo finance jobs in Dubai",
  "GRC jobs in Saudi Arabia",
  "compliance finance jobs in Saudi Arabia",
];
